...
class RoomPanel(QWidget):
    ...
    def _setup_ui(self):
        ...
        bili_logo = QLabel(); _bp = QPixmap(_os.path.join(_BASE, "assets", "bilibililogo.png")); bili_logo.setPixmap(_bp.scaled(24, 24, Qt.KeepAspectRatio, Qt.SmoothTransformation))
        bili_logo.setFixedSize(24, 24)
